...
export class LayoutGenerator {
  ...
  generateCTAButtons(context: 'meal' | 'foodlog', mealId?: string): string {
    ...
    const buttonStyle = isDarkTheme ? 
      'background: linear-gradient(135deg, rgba(15, 23, 42, 0.7), rgba(30, 41, 59, 0.6)); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(71, 85, 105, 0.2); border-radius: 16px; padding: 14px 28px; color: #f8fafc; font-weight: 500; cursor: pointer; transition: all 0.3s ease; font-size: 14px; display: inline-flex; align-items: center; gap: 10px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.03); position: relative; overflow: hidden;' :
      'background: linear-gradient(135deg, rgba(255, 255, 255, 0.9), rgba(248, 250, 252, 0.8)); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255, 255, 255, 0.7); border-radius: 16px; padding: 14px 28px; color: #475569; font-weight: 500; cursor: pointer; transition: all 0.3s ease; font-size: 14px; display: inline-flex; align-items: center; gap: 10px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.9); position: relative; overflow: hidden;';
    
    const hoverStyleDark = 'this.style.transform="translateY(-1px)"; this.style.background="linear-gradient(135deg, rgba(15, 23, 42, 0.8), rgba(30, 41, 59, 0.7))"; this.style.boxShadow="0 12px 40px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.05)"; this.style.borderColor="rgba(71, 85, 105, 0.25)";';
    const hoverStyleLight = 'this.style.transform="translateY(-1px)"; this.style.background="linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(248, 250, 252, 0.9))"; this.style.boxShadow="0 12px 40px rgba(0, 0, 0, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.95)"; this.style.borderColor="rgba(255, 255, 255, 0.8)";';
    
    const resetStyleDark = 'this.style.transform="translateY(0)"; this.style.background="linear-gradient(135deg, rgba(15, 23, 42, 0.7), rgba(30, 41, 59, 0.6))"; this.style.boxShadow="0 8px 32px rgba(0, 0, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.03)"; this.style.borderColor="rgba(71, 85, 105, 0.2)";';
    const resetStyleLight = 'this.style.transform="translateY(0)"; this.style.background="linear-gradient(135deg, rgba(255, 255, 255, 0.9), rgba(248, 250, 252, 0.8))"; this.style.boxShadow="0 8px 32px rgba(0, 0, 0, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.9)"; this.style.borderColor="rgba(255, 255, 255, 0.7)";';
