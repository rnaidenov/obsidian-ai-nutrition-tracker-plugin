...
export class LayoutGenerator {
  ...
  generateCTAButtons(context: 'meal' | 'foodlog', mealId?: string): string {
    ...
    const buttonStyle = isDarkTheme ? 
      'background: linear-gradient(135deg, rgba(30, 41, 59, 0.8), rgba(51, 65, 85, 0.6)); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(148, 163, 184, 0.3); border-radius: 16px; padding: 14px 28px; color: #f8fafc; font-weight: 500; cursor: pointer; transition: all 0.3s ease; font-size: 14px; display: inline-flex; align-items: center; gap: 10px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1); position: relative; overflow: hidden;' :
    ...
    const hoverStyleDark = 'this.style.transform="translateY(-1px)"; this.style.background="linear-gradient(135deg, rgba(30, 41, 59, 0.9), rgba(51, 65, 85, 0.8))"; this.style.boxShadow="0 12px 40px rgba(0, 0, 0, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.15)"; this.style.borderColor="rgba(148, 163, 184, 0.4)";';
    ...
    const resetStyleDark = 'this.style.transform="translateY(0)"; this.style.background="linear-gradient(135deg, rgba(30, 41, 59, 0.8), rgba(51, 65, 85, 0.6))"; this.style.boxShadow="0 8px 32px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1)"; this.style.borderColor="rgba(148, 163, 184, 0.3)";';
