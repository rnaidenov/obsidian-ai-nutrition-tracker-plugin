...
export class LayoutGenerator {
  ...
  generateCTAButtons(context: 'meal' | 'foodlog', mealId?: string): string {
    ...
    const buttonStyle = isDarkTheme ? 
      'background: linear-gradient(135deg, rgba(0, 0, 0, 0.4), rgba(20, 20, 20, 0.6), rgba(35, 35, 35, 0.3)); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1.5px solid rgba(0, 0, 0, 0.8); border-radius: 12px; padding: 14px 28px; color: #f1f5f9; font-weight: 500; cursor: pointer; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); font-size: 14px; display: inline-flex; align-items: center; gap: 10px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.35), 0 4px 16px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.06), inset 0 -1px 0 rgba(0, 0, 0, 0.2); position: relative; overflow: hidden; letter-spacing: 0.02em; text-shadow: 0 1px 2px rgba(0, 0, 0, 0.7);' :
      'background: linear-gradient(135deg, rgba(255, 255, 255, 0.8), rgba(248, 250, 252, 0.7), rgba(241, 245, 249, 0.6)); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1.5px solid rgba(100, 116, 139, 0.4); border-radius: 12px; padding: 14px 28px; color: #475569; font-weight: 500; cursor: pointer; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); font-size: 14px; display: inline-flex; align-items: center; gap: 10px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.8), inset 0 -1px 0 rgba(0, 0, 0, 0.03); position: relative; overflow: hidden; letter-spacing: 0.02em;';
    
    const hoverStyleDark = 'this.style.transform="translateY(-1px)"; this.style.background="linear-gradient(135deg, rgba(0, 0, 0, 0.5), rgba(25, 25, 25, 0.7), rgba(40, 40, 40, 0.4))"; this.style.boxShadow="0 12px 40px rgba(0, 0, 0, 0.45), 0 6px 20px rgba(0, 0, 0, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.08), inset 0 -1px 0 rgba(0, 0, 0, 0.25)"; this.style.borderColor="rgba(0, 0, 0, 0.9)"; this.style.color="#ffffff";';
    const hoverStyleLight = 'this.style.transform="translateY(-1px)"; this.style.background="linear-gradient(135deg, rgba(255, 255, 255, 0.9), rgba(248, 250, 252, 0.8), rgba(241, 245, 249, 0.7))"; this.style.boxShadow="0 12px 40px rgba(0, 0, 0, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.9), inset 0 -1px 0 rgba(0, 0, 0, 0.05)"; this.style.borderColor="rgba(100, 116, 139, 0.6)";';
    
    const resetStyleDark = 'this.style.transform="translateY(0)"; this.style.background="linear-gradient(135deg, rgba(0, 0, 0, 0.4), rgba(20, 20, 20, 0.6), rgba(35, 35, 35, 0.3))"; this.style.boxShadow="0 8px 32px rgba(0, 0, 0, 0.35), 0 4px 16px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.06), inset 0 -1px 0 rgba(0, 0, 0, 0.2)"; this.style.borderColor="rgba(0, 0, 0, 0.8)"; this.style.color="#f1f5f9";';
    const resetStyleLight = 'this.style.transform="translateY(0)"; this.style.background="linear-gradient(135deg, rgba(255, 255, 255, 0.8), rgba(248, 250, 252, 0.7), rgba(241, 245, 249, 0.6))"; this.style.boxShadow="0 8px 32px rgba(0, 0, 0, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.8), inset 0 -1px 0 rgba(0, 0, 0, 0.03)"; this.style.borderColor="rgba(100, 116, 139, 0.4)";';
    
    const buttonHtml = `<div style="text-align: center; margin-top: 20px;"><button id="${buttonId}" class="nutrition-add-cta-btn" data-context="${context}"${mealIdAttr} style="${buttonStyle}" onmouseover="${isDarkTheme ? hoverStyleDark : hoverStyleLight}" onmouseout="${isDarkTheme ? resetStyleDark : resetStyleLight}">${buttonText}</button></div>`;
